...
* **Fix**: Ensure the alpha channel outside the 824x824 squircle is 0. Run `generate-icon.sh` or mask the PNG with an explicit transparent alpha channel before compiling with `iconutil`.
